                      ...
                      <div className="text-end contact-btn">
                        <div className='col-xl-12 col-lg-12 col-md-12 col-12'>
                          <div className='connect-area'>
                            ...
                            <button onClick={() => handleActiveTime("Chat", item)} style={{ fontSize: '15px', padding: '3px', width: '52%' }} disabled={!item.chatStatus} className={`btn mt-2 ${item.chatStatus === true ? 'profile-chat-btn' : 'profile-call-btn'}`}><i class="fa-regular fa-comments"></i> Chat</button>
