...
function AllPlanJourneyImage() {
    ...
    const handleFetchBanner = async () => {
        setLoading(true);
        try {
            const { data } = await axios.get('https://try.helpubuild.co.in/api/v1/get-all-plan-journey-image');
    ...
    const handleUpdateActive = async (id, currentStatus) => {
        ...
        try {
            ...
            await axios.put(`https://try.helpubuild.co.in/api/v1/update-plan-banner-status/${id}`, {
    ...
    const handleDeleteBanner = async (id) => {
        setLoading(true);
        try {
            await axios.delete(`https://try.helpubuild.co.in/api/v1/delete-plan-journey-image/${id}`);
