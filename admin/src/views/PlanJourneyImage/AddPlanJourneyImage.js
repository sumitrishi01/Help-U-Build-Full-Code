...
function AddPlanJourneyImage() {
    ...
    const handleSubmit = async (e) => {
        ...
        setLoading(true);
        try {
            const res = await axios.post('https://api.helpubuild.co.in/api/v1/create-plan-journey-image', payload, {
    ...
    return (
        <>
            <Form
                heading="Add Plan Journey Image"
                btnText="Back"
                btnURL="/plan_journey_image/all_plan_journey_image"
...
export default AddPlanJourneyImage
