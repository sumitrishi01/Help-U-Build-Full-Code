...
function AllBanner() {
    ...
    const handleFetchBanner = async () => {
        setLoading(true);
        try {
            const { data } = await axios.get('https://try.helpubuild.co.in/api/v1/get-all-banner');
    ...
    const handleUpdateActive = async (id, currentStatus) => {
        try {
            ...
            await axios.put(`https://try.helpubuild.co.in/api/v1/update-banner-status/${id}`, {
    ...
    const handleDeleteBanner = async (id) => {
        try {
            setLoading(true);
            await axios.delete(`https://try.helpubuild.co.in/api/v1/delete-banner/${id}`);
