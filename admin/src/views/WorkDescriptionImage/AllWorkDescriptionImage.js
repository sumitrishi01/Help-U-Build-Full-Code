...
function AllWorkDescriptionImage() {
    ...
    const handleFetchBanner = async () => {
        setLoading(true);
        try {
            const { data } = await axios.get('https://try.helpubuild.co.in/api/v1/get-all-describe-work-image');
    ...
    const handleUpdateActive = async (id, currentStatus) => {
        ...
        try {
            ...
            await axios.put(`https://try.helpubuild.co.in/api/v1/update-work-banner-status/${id}`, {
    ...
    const handleDeleteBanner = async (id) => {
        setLoading(true);
        try {
            await axios.delete(`https://try.helpubuild.co.in/api/v1/delete-describe-work-image/${id}`);
